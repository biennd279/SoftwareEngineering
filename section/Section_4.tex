...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=0.8\textwidth]{figure_8_4.png}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=0.8\textwidth]{figure_8_5.png}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=0.8\textwidth]{figure_8_6.png}
	\caption{Sơ đồ thành phần UML}
	\label{fig:fig8_6}
\end{figure}

Trong trường hợp phần mềm hướng tới đối tượng, một sơ đồ thành phần UML được biểu diễn\autoref{fig:fig8_6}Trong hình này là  một thành phần có tên là \textbf{SensorManagement} (Quản lý cảm biến) (một phần trong các chức năng của SafeHome). Mũi tên nét đứt nối với class có tên là \textbf{Sensor} được kế thừa từ đó.
...
\begin{figure}[htb!]
	\centering
	\includegraphics[width=0.7\textwidth]{figure_8_7.png}
