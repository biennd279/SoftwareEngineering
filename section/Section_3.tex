...
Độc lập chức năng đạt được bằng việc phát triển các module với một chức năng duy nhất. Nói cách khác, bạn nên thiết kế phần mềm sao cho mỗi module xử lý một tập con các yêu cầu cụ thể và sở hữu một \acrshort{API} đơn giản. \textit{Vậy tại sao độc lập tính năng lại quan trọng?}
